...
* plik main.py - to główny plik w którym ma się zawierać kod. Najbezpieczniej jest odpalać go pod linią if __name__ == "__main__" i wywoływać odpowiednie funkcje/metody
